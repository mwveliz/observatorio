...
abstract class BaseStatus extends BaseObject  implements Persistent
{
	...
	/**
	 * The value for the aprobacion field.
	 * @var        boolean
	 */
	...
	/**
	 * Get the [aprobacion] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = StatusPeer::DESCRIPCION;
		}
	...
	/**
	 * Set the value of [aprobacion] column.
	 * 
	...
	public function setAprobacion($v)
	{
		...
		if ($this->aprobacion !== $v) {
			$this->aprobacion = $v;
			$this->modifiedColumns[] = StatusPeer::APROBACION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->aprobacion = ($row[$startcol + 2] !== null) ? (boolean) $row[$startcol + 2] : null;
			$this->resetModified();
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StatusPeer::DESCRIPCION)) $criteria->add(StatusPeer::DESCRIPCION, $this->descripcion);
		if ($this->isColumnModified(StatusPeer::APROBACION)) $criteria->add(StatusPeer::APROBACION, $this->aprobacion);
