...
/**
 * Base static class for performing query and update operations on the 'tipopublicacion' table.
 *
 * 
 *
...
abstract class BaseTipopublicacionPeer {
	...
	const TABLE_NAME = 'tipopublicacion';

	/** the related Propel class for this table */
	const OM_CLASS = 'Tipopublicacion';

	/** A class that can be returned by this peer. */
	const CLASS_DEFAULT = 'lib.model.Tipopublicacion';

	/** the related TableMap class for this table */
	const TM_CLASS = 'TipopublicacionTableMap';
	...
	const ID = 'tipopublicacion.ID';

	/** the column name for the DESCRIPCION field */
	const DESCRIPCION = 'tipopublicacion.DESCRIPCION';

	/**
	 * An identiy map to hold any loaded instances of Tipopublicacion objects.
	...
	{
		if (null === $alias) {
			$criteria->addSelectColumn(TipopublicacionPeer::ID);
			$criteria->addSelectColumn(TipopublicacionPeer::DESCRIPCION);
		} else {
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseTipopublicacionPeer', $criteria, $con);
		}
	 ...
	 *
	 * @param      Tipopublicacion $value A Tipopublicacion object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Tipopublicacion $obj, $key = null)
	{
	...
	/**
	 * Method to invalidate the instance pool of all tables related to tipopublicacion
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = TipopublicacionPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + TipopublicacionPeer::NUM_COLUMNS;
		} else {
	...
	public static function buildTableMap()
	{
	  ...
	  {
	    $dbMap->addTableObject(new TipopublicacionTableMap());
	  }
	}
	...
	{
		return $withPrefix ? TipopublicacionPeer::CLASS_DEFAULT : TipopublicacionPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Tipopublicacion or Criteria object.
	 *
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(TipopublicacionPeer::ID) && $criteria->keyContainsValue(TipopublicacionPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.TipopublicacionPeer::ID.')');
		}
	...
	/**
	 * Method perform an UPDATE on the database, given a Tipopublicacion or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(TipopublicacionPeer::ID);
			$value = $criteria->remove(TipopublicacionPeer::ID);
			if ($value) {
				$selectCriteria->add(TipopublicacionPeer::ID, $value, $comparison);
			} else {
	...
	/**
	 * Method to DELETE all rows from the tipopublicacion table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	/**
	 * Method perform a DELETE on the database, given a Tipopublicacion or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(TipopublicacionPeer::ID, (array) $values, Criteria::IN);
	 ...
	 */
	public static function doValidate(Tipopublicacion $obj, $cols = null)
	{
		$columns = array();
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(TipopublicacionPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(TipopublicacionPeer::DATABASE_NAME);
			$criteria->add(TipopublicacionPeer::ID, $pks, Criteria::IN);
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseTipopublicacionPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
