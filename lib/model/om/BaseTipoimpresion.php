...
/**
 * Base class that represents a row from the 'tipoimpresion' table.
 *
 * 
 *
 ...
 */
abstract class BaseTipoimpresion extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'TipoimpresionPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        TipoimpresionPeer
	 */
	 ...
	 * @return     Tipoimpresion The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TipoimpresionPeer::ID;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = TipoimpresionPeer::DESCRIPCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = TipoimpresionPeer::NUM_COLUMNS - TipoimpresionPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tipoimpresion object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipoimpresionPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTipoimpresion:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TipoimpresionQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTipoimpresion:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTipoimpresion:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTipoimpresion:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				TipoimpresionPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(TipoimpresionPeer::ID) ) {
					...
					$affectedRows = TipoimpresionPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TipoimpresionPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TipoimpresionPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TipoimpresionPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipoimpresionPeer::ID)) $criteria->add(TipoimpresionPeer::ID, $this->id);
		if ($this->isColumnModified(TipoimpresionPeer::DESCRIPCION)) $criteria->add(TipoimpresionPeer::DESCRIPCION, $this->descripcion);
	...
	{
		$criteria = new Criteria(TipoimpresionPeer::DATABASE_NAME);
		$criteria->add(TipoimpresionPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tipoimpresion (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tipoimpresion Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TipoimpresionPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TipoimpresionPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Tipoimpresion is new, it will return
	 ...
	 * Otherwise if this Tipoimpresion is new, it will return
	 * an empty collection; or if this Tipoimpresion has previously
	 * been saved, it will retrieve related Impresions from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tipoimpresion.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseTipoimpresion:' . $name))
		{
