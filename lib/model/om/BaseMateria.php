...
abstract class BaseMateria extends BaseObject  implements Persistent
{
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = MateriaPeer::DESCRIPCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = MateriaPeer::NUM_COLUMNS - MateriaPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(MateriaPeer::ID) ) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MateriaPeer::DESCRIPCION)) $criteria->add(MateriaPeer::DESCRIPCION, $this->descripcion);
