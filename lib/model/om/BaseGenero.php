...
abstract class BaseGenero extends BaseObject  implements Persistent
{
	...
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = GeneroPeer::ID;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = GeneroPeer::NUM_COLUMNS - GeneroPeer::NUM_LAZY_LOAD_COLUMNS).
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(GeneroPeer::ID) ) {
					...
					$affectedRows = GeneroPeer::doUpdate($this, $con);
				}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GeneroPeer::ID)) $criteria->add(GeneroPeer::ID, $this->id);
	...
	{
		$criteria = new Criteria(GeneroPeer::DATABASE_NAME);
		$criteria->add(GeneroPeer::ID, $this->id);
