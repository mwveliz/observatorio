...
/**
 * Base class that represents a row from the 'tipotripa' table.
 *
 * 
 *
 ...
 */
abstract class BaseTipotripa extends BaseObject  implements Persistent
{

	/**
	 * Peer class name
	 */
	const PEER = 'TipotripaPeer';
	 ...
	 * @return     Tipotripa The current object (for fluent API support)
	 */
	public function setId($v)
	{
		...
		if ($this->id !== $v) {
			$this->id = $v;
			$this->modifiedColumns[] = TipotripaPeer::ID;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = TipotripaPeer::DESCRIPCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 2; // 2 = TipotripaPeer::NUM_COLUMNS - TipotripaPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating Tipotripa object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipotripaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTipotripa:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TipotripaQuery::create()
					->filterByPrimaryKey($this->getPrimaryKey())
					->delete($con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTipotripa:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTipotripa:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTipotripa:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				TipotripaPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(TipotripaPeer::ID) ) {
					...
					$affectedRows = TipotripaPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TipotripaPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TipotripaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TipotripaPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getId(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipotripaPeer::ID)) $criteria->add(TipotripaPeer::ID, $this->id);
		if ($this->isColumnModified(TipotripaPeer::DESCRIPCION)) $criteria->add(TipotripaPeer::DESCRIPCION, $this->descripcion);
	...
	{
		$criteria = new Criteria(TipotripaPeer::DATABASE_NAME);
		$criteria->add(TipotripaPeer::ID, $this->id);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of Tipotripa (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     Tipotripa Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TipotripaPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TipotripaPeer();
		}
		return self::$peer;
	}
	 ...
	 * If this Tipotripa is new, it will return
	 ...
	 * Otherwise if this Tipotripa is new, it will return
	 * an empty collection; or if this Tipotripa has previously
	 * been saved, it will retrieve related Impresions from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in Tipotripa.
	 *
	 * @param      Criteria $criteria optional Criteria object to narrow the query
	 * @param      PropelPDO $con optional connection object
	...
	{
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseTipotripa:' . $name))
		{
